...
//        }
    ...
    public void showInfo(int gameNumbers) {
        int size = this.players.size();
...
//        event.addPlayer(new random02.AI());
//        event.addPlayer(new random03.AI());
...
//    }
    ...
    public static void main(String[] args) {
        ...
        GameEvent event1 = new GameEvent("Report01");

//        event1.addPlayer(new status2.AI());
//        event1.addPlayer(new status2.AI());
        event1.addPlayer(new status3.AI());
        event1.addPlayer(new g02DTSS.AI());
        event1.addPlayer(new status1.AI());

        event1.arrangeMatches(gameNumbers);
        event1.runSingleThread();
        event1.showInfo(gameNumbers);

//        GameEvent event2 = new GameEvent("Report02");
//        event2.addPlayer(new g02DTSS.AI());
//        event2.addPlayer(new g02.AI());
//        event2.arrangeMatches(gameNumbers);
//        event2.runMultiThread();
//        event2.showInfo(gameNumbers);
    }
}
