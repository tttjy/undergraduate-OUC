...
class Create_Dataset(keras.utils.):
    
    def __init__(self, batch_size, input_img_paths,image_size=(256,256),stage = 'test',augment = True):
    ...
    def __getitem__(self, idx):
        ...
        for j, path in enumerate(batch_input_img_paths):
            ...
            input_images,segmentations = path_split(path,self.stages['test'],self.img_size,aug_par)
            if self.stages['train']:
