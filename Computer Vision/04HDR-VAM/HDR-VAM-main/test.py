...
if __name__ == '__main__':
    ...
    if 'weights.h5' in os.listdir('E:/桌面/计算机视觉/HDR-VAM-main/HDR-VAM-main/weight'):
        print('---------Loading Weights---------\n')
        model_.load_weights('E:/桌面/计算机视觉/HDR-VAM-main/HDR-VAM-main/weight/weights.h5')


    test_dir = 'E:/桌面/计算机视觉/HDR-VAM-main/Test/LDR/short'
    out_path = 'E:/桌面/计算机视觉/HDR-VAM-main/Test/HDR'
    test_input_img_paths = name_sorting(test_dir)

    print('---------Making Dataset Generator---------\n')
    test_gen = Create_Dataset(batch_size,test_input_img_paths,stage='test',augment=True)
