...
<html>
  <head>
    <link
      rel="stylesheet"
      href="${pageContext.request.contextPath }/res/editer/themes/default/default.css"
    />
    <link
      rel="stylesheet"
      href="${pageContext.request.contextPath }/res/editer/plugins/code/prettify.css"
    />
    <script
    ...
    <script
      charset="utf-8"
      src="${pageContext.request.contextPath }/res/editer/kindeditor.js"
    ></script>
    <script
      charset="utf-8"
      src="${pageContext.request.contextPath }/res/editer/lang/zh_CN.js"
    ></script>
    <script
      charset="utf-8"
      src="${pageContext.request.contextPath }/res/editer/plugins/code/prettify.js"
    ></script>
    <title></title>
  </head>
  <script>
  ...
  <body>
    <div style="padding: 10px">
      ...
      <form
        action="${pageContext.request.contextPath }/question/save.action"
        method="post"
        class="table"
        style="width: 80%"
      >
        ...
        <table class="table table-bordered table-hover table-striped">
          ...
          <tr>
            ...
            <td>
              ...
              JP维度 <input type="radio" name='type' value="2" ${question.type
              eq 2?'checked':'' } /> TF维度 <input type="radio" name='type'
              value="3" ${question.type eq 3?'checked':'' } /> SN维度 <input
              type="radio" name='type' value="4" ${question.type eq
              4?'checked':'' } /> EL维度
            </td>
          </tr>
          <c:forEach var="i" begin="0" end="3">
            <tr>
              ...
              <td>
                ...
                ${choices[i].checked?'checked':'' } value='1'/> 正确选项
              </td>
            </tr>
          </c:forEach>
          <tr>
