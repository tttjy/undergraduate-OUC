      ...
      >
        ...
        <c:forEach var="i" begin="0" end="3"
          ><jsp:useBean
            id="choices"
            scope="request"
            type="java.util.List<com.qst.entity.Choice>"
          />
        ...
        <c:if test="${param.delete eq 1 }">
          <tr>
            <td colspan="2" style="text-align: center">
              <a
                href="${pageContext.request.contextPath }/question/delete.action?id=${question.id }&assessmentId=${question.assessmentId}"
                class="button"
                >确认删除</a
              >
            </td>
