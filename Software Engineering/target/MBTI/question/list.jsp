    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        <c:forEach var="p" varStatus="vs" items="${questionList }">
            <tr class="body">
                ...
                <td>${p.title }</td>
                <td><a class="button"
                       href="${pageContext.request.contextPath }/question/view.action?id=${p.id }">查看</a> <a
                        class="button"
                        href="${pageContext.request.contextPath }/question/edit.action?id=${p.id }">修改</a> <a
                        class="button"
                        href="${pageContext.request.contextPath }/question/view.action?id=${p.id }&delete=1">删除</a>
                </td>
            </tr>
        </c:forEach>
    </table>
