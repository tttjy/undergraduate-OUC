      ...
      j = (function (o) {
        ...
        n.prototype.defaultOptions = {
          ...
          resize: function (r) {
            ...
            if (
              r.height < this.options.thumbnailHeight ||
          ...
          addedfile: function (q) {
            ...
            q.previewElement.querySelector('[data-dz-name]').textContent =
              q.name
            q.previewElement.querySelector('[data-dz-size]').innerHTML =
              this.filesize(q.size)
            if (this.options.addRemoveLinks) {
              q._removeLink = n.createElement(
          ...
          error: function (q, r) {
            ...
            return (q.previewElement.querySelector(
          ...
          uploadprogress: function (s, q, r) {
            return (s.previewElement.querySelector(
        ...
        n.prototype.getFallbackForm = function () {
          ...
          if (this.element.tagName !== 'FORM') {
            s = n.createElement(
              '<form action="../../../../H-ui.admin/v2.0/js/' +
                this.options.url +
          ...
          if (r.size > this.options.maxFilesize * 1024 * 1024) {
            return q(
              this.options.dictFileTooBig
                .replace(
                  '{{filesize}}',
                  Math.round(r.size / 1024 / 10.24) / 100
                )
          ...
          u = function (v) {
            ...
            for (x = 0, w = v.length; x < w; x++) {
              ...
              if (r.isFile) {
                r.file(function (y) {
                  if (
                    t.options.ignoreHiddenFiles &&
                    y.name.substring(0, 1) === '.'
                  ) {
                    return
                  }
                  y.fullPath = '' + s + '/' + y.name
            ...
            for (V = 0, U = z.length; V < U; V++) {
              ...
              T.push(
                L._errorProcessing(
                  z,
                  r ||
                    L.options.dictResponseError.replace(
                      '{{statusCode}}',
                      C.status
                    ),
                  C
