...
$(function () {
  ...
  $('.placeholder').click(function () {
    $(this).hide()
    $(this).parents('p').find('.input-text').focus()
  })
  /*得到焦点*/
  function inputfocus(obj) {
    if ($(obj).val() == '') {
      $(obj).parent().find('.placeholder').hide()
    }
  }
  /*失去焦点*/
  function inputblur(obj) {
    if ($(obj).val() == '') {
      $(obj).parent().find('.placeholder').show()
    }
  }
  ...
  ;($backToTopEle = $(
    ...
    ($backToTopFun = function () {
      ...
      /*IE6下的定位*/ if (!window.XMLHttpRequest) {
  ...
  $('#fontbig').click(function () {
    ...
    $(this).css('color', '#666')
    $('#cnt_main_article').css('font-size', '18px')
  })
  $('#fontSmall').click(function () {
    $('#fontbig').css('color', '#0B3B8C')
    $(this).css('color', '#666')
    $('#cnt_main_article').css('font-size', '14px')
  })
  ...
  $('a.preview').hover(
    function () {
      ...
      var tooltip_keleyi_com =
        "<div id='tooltip-preview' style='top:" +
        imgT +
        'px;right:' +
        tooltipRight +
        ';left:' +
  ...
  $taghas.find('span').click(function () {
    ...
    $('<span class="hui-tags-token">' + taghasV + '</span>').insertBefore(
      $tagswp
    )
    $taginput.focus()
  })
