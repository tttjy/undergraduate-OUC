  ...
  var M = function (g) {
    ...
    function G(a, b, c) {
      ...
      g.each(b, function (e) {
        ...
        if (d !== l && (c || b[d] === l))
          'o' === d.charAt(0)
            ? (b[d] || (b[d] = {}), g.extend(!0, b[d], b[e]), G(a[d], b[d], c))
            : (b[d] = b[e])
      })
    }
    function M(a) {
    ...
    function fa(a, b, c) {
      ...
      d._bAttrSrc =
        g.isPlainObject(c) && (f(c.sort) || f(c.type) || f(c.filter))
      ...
      !d.bSortable || (!a && !e)
        ...
        : a && !e
        ? ((d.sSortingClass = b.sSortableAsc),
          (d.sSortingClassJUI = b.sSortJUIAscAllowed))
        : !a && e
        ? ((d.sSortingClass = b.sSortableDesc),
          (d.sSortingClassJUI = b.sSortJUIDescAllowed))
      ...
      var c = [],
        ...
        o = function (a, b, c) {
          'string' === typeof a &&
            ((b = a.indexOf('@')),
            -1 !== b &&
              ((a = a.substring(b + 1)), (i['@' + a] = c.getAttribute(a))))
        },
        k = function (a) {
          h = m[j]
    ...
    function Fa(a, b, c, d) {
      ...
      if (null === e.nTr) {
        ...
        for (o = a.aoColumns.length; m < o; m++) {
          ...
          g.fnCreatedCell &&
            g.fnCreatedCell.call(a.oInstance, j, A(a, b, m, 'display'), f, b, m)
        }
        ...
        for (e = h.length; d < e; d++) {
          ...
          for (b = h[d].length; f < b; f++)
            if (((n = j = 1), i[d][f] === l)) {
              ...
              for (
                i[d][f] = 1;
                h[d + j] !== l && h[d][f].cell == h[d + j][f].cell;
    ...
    function vb(a) {
      for (
        var b = p.ext.search, c = a.aiDisplay, d, e, f = 0, h = b.length;
        f < h;
        f++
      )
    ...
    function ub(a, b, c, d, e, f) {
      if ('' !== b)
        for (
          var h = a.aiDisplay, d = Na(b, d, e, f), e = h.length - 1;
          0 <= e;
          e--
        )
        ...
        if (((g = a.aoData[d]), !g._aFilterData)) {
          ...
          for (h = b.length; e < h; e++)
            (c = b[e]),
              c.bSearchable
                ? ((j = A(a, d, e, 'filter')),
                  (j = m[c.sType] ? m[c.sType](j) : null !== j ? j : ''))
                : (j = ''),
              j.indexOf &&
                -1 !== j.indexOf('&') &&
                ((qa.innerHTML = j), (j = Tb ? qa.textContent : qa.innerText)),
    ...
    function V(a) {
      ...
      t &&
        ((w = t.clone().prependTo(q)), (u = t.find('tr')), (w = w.find('tr')))
    ...
    function Ca(a) {
      ...
      if (!o && !f && !e && i == Y(a) && i == j.length)
        ...
        for (k = 0; k < d.length; k++)
          if (((l = c[d[k]]), (e = g(j[k]).width()))) l.sWidth = s(e)
    ...
    function Ua(a, b) {
      ...
      b <= c
        ...
        : (a >= b - 1 - d
            ? (c = R(b - (c - 2), b))
            : ((c = R(a - 1, a + 2)), c.push('ellipsis'), c.push(b - 1)),
    ...
    q.register = r = function (a, b) {
      if (g.isArray(a))
        ...
        for (
          var e = a.split('.'), f = Ob, h, i, c = 0, d = e.length;
          c < d;
          c++
        ) {
    ...
    g.extend(p.ext.type.detect, [
      ...
      function (a) {
        return da(a) || ('string' === typeof a && -1 !== a.indexOf('<'))
          ? 'html'
          : null
      },
    ])
      ...
      number: function (a, b, c, d) {
        return {
          display: function (e) {
            ...
            return (
              (d || '') + f.toString().replace(/\B(?=(\d{3})+(?!\d))/g, a) + e
            )
          },
        }
      },
