  ...
  $('a.preview').hover(
    function (e) {
      ...
      timer = setTimeout(function () {
        ...
        var imgT2 = imgT
        if (pointY > winH5) {
          imgT2 = imgT - midimgH + 128
        } else {
          imgT2 = imgT
        }
        var tooltip_keleyi_com =
          "<div id='tooltip-keleyi-com' style='top:" +
          imgT2 +
          'px;right:' +
          tooltipRight +
          ';left:' +
          tooltipLeft +
          "'><span id='tooltip-keleyi-div' style='width:" +
          midimgW +
          'px; height:' +
          midimgH +
          "px'><img src='" +
          ...
          "' width='" +
          midimgW2 +
          "' class='thumbpic'></span></div>"

        $('body').append(tooltip_keleyi_com)

        var imgTitle = _this.myTitle
          ? '<br />' + _this.myTitle + ' 产品预览图'
          : ''
        /*图片预加载*/
