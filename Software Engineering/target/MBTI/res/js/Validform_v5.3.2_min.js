  ...
  a.util = {
    ...
    getValue: function (m) {
      ...
      if (m.is(':radio')) {
        ...
        if (m.is(':checkbox')) {
          l = ''
          k.find(":checkbox[name='" + m.attr('name') + "']:checked").each(
            function () {
              l += d(this).val() + ','
            }
          )
      ...
      if (r != 'addRule' && o.jqtransform && d.fn.jqTransSelect) {
        ...
        if (o.jqtransform.selector) {
          s.find(o.jqtransform.selector)
            .filter('input:submit, input:reset, input[type="button"]')
            .jqTransInputButton()
          s.find(o.jqtransform.selector)
    ...
    getNullmsg: function (o) {
      ...
      l =
        n.siblings(l).eq(0).text() ||
        n.siblings().find(l).eq(0).text() ||
      ...
      if (v) {
        ...
        if (u.attr('recheck')) {
          ...
          if (n != p.val()) {
            ...
            l = 3
            y =
              u.attr('errormsg') || a.util.getErrormsg.call(u, A, t, 'recheck')
          }
        }
      } else {
