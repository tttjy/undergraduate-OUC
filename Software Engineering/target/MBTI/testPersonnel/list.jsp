        ...
        <tr>
            <td class="head" colspan="7">
                <form action="${pageContext.request.contextPath }/testPersonnel/select.action" method="post">
                    ...
                    <p style="float: left;margin-left: 10px;font-size: 15px;margin-top: 3px">姓名</p><input
                        class="form-control wid" type="text" name="stuname">
                    <p style="float: left;margin-left: 10px;font-size: 15px;margin-top: 3px">手机号</p><input
                        class="form-control wid" type="text" name="phone">
        ...
        <c:forEach var="m" varStatus="vs" items="${testPersonnel }">
            <tr>
                ...
                <td>
                    ...
                    <a class="button"
                       href="${pageContext.request.contextPath }/testPersonnel/view.action?id=${m.id }&delete=1">删除</a>
                </td>
            </tr>
        </c:forEach>
    </table>
