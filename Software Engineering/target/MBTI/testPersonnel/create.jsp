...
<div style="padding: 10px;">
    <a href="${pageContext.request.contextPath }/team/list.action" class="button">
        <button class="btn btn-warning" style="margin-bottom: 10px">返回列表</button>
    </a>
    <%@ include file="/inc/msg.jsp" %>
    <form action="${pageContext.request.contextPath }/testPersonnel/add.action" method="post" class="table"
          style="width: 80%;">
        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            <tr>
                <td colspan="2" class="edit"><input class="btn btn-warning" type="submit" value="保存"/><input
                        class="btn btn-warning" type="reset" value="重置"/></td>
            </tr>
        </table>
    </form>
</div>
