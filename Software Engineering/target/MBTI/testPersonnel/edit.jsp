...
<html>
  ...
  <body>
    <div style="padding: 10px">
      ...
      <form
        action="${pageContext.request.contextPath }/testPersonnel/update.action"
        method="post"
        class="table"
        style="width: 80%"
      >
        ...
        <table class="table table-bordered table-hover table-striped">
          ...
          <tr>
            ...
            <td>
              ...
              ${testPersonnel.gender =="F"?'checked':'' }> 女
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              ...
              正常 <input type="radio" name="status" value="2"
              ${testPersonnel.user.status eq 2?'checked':'' }> 禁用
            </td>
          </tr>
          <tr>
