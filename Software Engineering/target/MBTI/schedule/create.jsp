...
<div style="padding: 10px;">
    ...
    <form action="${pageContext.request.contextPath }/schedule/save.action" method="post" class="table"
          style="width: 80%;">
        <table class="table table-bordered table-hover table-striped">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input class="form-control" type="datetime-local" step="01" name="beginDate"
                           value="2021/01/12 21:14:07" style="width: 200px;">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <input class="form-control" type="datetime-local" step="01" name="endDate"
                           value="2021/01/12 21:14:07" style="width: 200px;">
                </td>
            </tr>
            <tr>
