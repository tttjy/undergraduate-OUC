...
<html>
  ...
  <body>
    <div style="padding: 10px">
      <a
        href="${pageContext.request.contextPath }/schedule/create.action"
        class="button"
      >
        ...
        <c:forEach var="u" varStatus="vs" items="${scheduleList }">
          <tr class="body">
            ...
            <td>
              <a
                class="button"
                href="${pageContext.request.contextPath }/schedule/view.action?id=${u.id }"
                >查看</a
              >
              <a
                class="button"
                href="${pageContext.request.contextPath }/schedule/edit.action?id=${u.id }"
                >修改</a
              >
              <a
                class="button"
                href="${pageContext.request.contextPath }/schedule/view.action?id=${u.id }&delete=1"
                >删除</a
              >
              <c:if test="${u.status eq 3 }">
                <a
                  class="button"
                  href="${pageContext.request.contextPath }/schedule/score.action?id=${u.id }"
                  >考试成绩</a
                >
              </c:if>
            </td>
