...
<div style="padding: 10px;">
    <a href="${pageContext.request.contextPath }/schedule/list.action" class="button">
        <button class="btn btn-warning" style="margin-bottom: 10px">返回列表</button>
    </a>
    <%@ include file="/inc/msg.jsp" %>
    <form action="${pageContext.request.contextPath }/schedule/update.action" method="post" class="table"
          style="width: 80%;">
        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input class="form-control" type="datetime-local" step="01" name="beginDate" style="width: 200px;"
                           required="required">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <input class="form-control" type="datetime-local" step="01" name="endDate" style="width: 200px;"
                           required="required">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="radio" name="status" value="0" checked>作废</input> <input type="radio"
                                                                                            name="status"
                                                                                            value="1" ${schedule.status eq 1?'checked':'' }>未考</input>
                    <input type="radio"
                           name="status" value="2" ${schedule.status eq 2?'checked':'' }>考试中</input> <input
                            type="radio"
