...
<html>
  <head>
    ...
    <script
      ...
      src="${pageContext.request.contextPath }/res/js/jquery.min.js"
    ></script>
    <link
      rel="stylesheet"
    ...
    <link
      type="text/css"
      rel="stylesheet"
      href="${pageContext.request.contextPath }/res/font/font-awesome.min.css"
    />
  </head>
      ...
      <div class="from1">
        <form id="loginForm" method="post">
          <div class="username">
            <div class="usernameinner">
              ...
              <input
                ...
                --%
              />
              <%-- placeholder="请输入你的手机号" value='${login }'/>--%>
              <input
                type="text"
                name="login"
                id="username"
          ...
          <div style="margin-top: -25px">
            <img
              src="${pageContext.request.contextPath }/res/images/line.png"
              style="width: 280px"
            />
          </div>
          <div class="password">
          ...
          <div style="margin-top: 8px">
            <a href="javascript:login()"
              ><img
                src="${pageContext.request.contextPath }/res/images/sub.png"
          ...
          <div style="margin-top: 8px">
            <a href="javascript:reg()"
              ><img
                src="${pageContext.request.contextPath }/res/images/reg.png"
                style="width: 280px; height: 35px"
            /></a>
          </div>
        </form>
