        ...
        <c:if test="${not empty q }">
            <form id="exam-form" method="post" action="${pageContext.request.contextPath }/exam/exam.action">
                ...
                <div class="exam-panel">
                    <br/>
                    <button class="btn btn-warning" style="margin-bottom: 4px;margin-left: 400px;" idx='-1'>上一题
                    </button>
                    <button class="btn btn-warning" style="margin-bottom: 4px;margin-left: 20px" idx='-2'>下一题
                    </button>
                        ...
                        <tr>
                            <td>
                                ...
                                <button class="exam-panel-cell "
                                        idx='${s.index }'
                                        style="height:40px;width:40px;background-color: ${empty p.answer?'white':'yellow'}">${s.index+1}</button>
