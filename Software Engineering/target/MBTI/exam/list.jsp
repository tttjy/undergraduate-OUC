    ...
    <div style="padding: 10px">
      ...
      <table class="table table-bordered table-hover table-striped">
        ...
        <jsp:useBean
          id="scheduleList"
          scope="request"
          type="java.util.List<com.qst.entity.Schedule>"
        />
          ...
          <tr class="body">
            ...
            <td>
              <c:if test="${not empty u.extras['exam'].result  }">
                <a
                  class="button"
                  href="${pageContext.request.contextPath }/exam/result.action?id=${u.extras['exam'].id }"
                  >查看结果</a
                >
              </c:if>
              <c:if test="${u.status eq 2 and empty u.extras['exam'] }">
                <a
                  class="button"
                  href="${pageContext.request.contextPath }/exam/begin.action?id=${u.id }"
                  >开始考试</a
                >
              </c:if>
            </td>
