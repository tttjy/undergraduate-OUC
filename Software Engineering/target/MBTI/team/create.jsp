...
<html>
  ...
  <body>
    <div style="padding: 10px">
      <a
        href="${pageContext.request.contextPath }/team/list.action"
        class="button"
      >
      ...
      <form
        action="${pageContext.request.contextPath }/team/save.action"
        method="post"
        class="table"
        style="width: 80%"
      >
        <table class="table table-bordered table-hover table-striped">
          ...
          <tr>
            ...
            <td>
              <input type="date" name="beginYear" value="${team.beginYear }" />
            </td>
          </tr>
          <tr>
            ...
            <td>
              ...
              <label>
                <input type="radio" name="status" value="1" ${1 eq
                team.status?'checked':'' }> 正常
              </label>
            </td>
          </tr>
          <tr>
