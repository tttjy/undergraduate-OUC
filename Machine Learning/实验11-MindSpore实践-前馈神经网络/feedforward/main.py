...
parser.add_argument('--data_url', required=False, default='D:\python\code\huawei\Fashionmnist', help='Location of Fashionmnist.')
parser.add_argument('--train_url', required=False, default='D:\python\code\huawei\Fashionmnist\output', help='Location of training outputs.')
args, unknown = parser.parse_known_args()

# import moxing
#
# # copy dataset from your own OBS bucket.
# moxing.file.copy_parallel(src_url=args.data_url, dst_url='Fashionmnist')
...
cfg = edict({
    ...
    'lr': 0.001,  # 学习率
    'epoch_size': 20,  # 训练次数
    'data_dir_train': os.path.join('Fashionmnist', 'train'),
    'data_dir_test': os.path.join('Fashionmnist', 'test'),
